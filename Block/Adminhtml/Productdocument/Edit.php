...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    {
        $this->_objectId = 'productdocument_id';
        ...
        if ($this->_isAllowedAction('Abm_Productdocument::productdocument_delete')) {
    ...
    {
        if ($this->_coreRegistry->registry('productdocument')->getId()) {
            return __(
                "Edit Document '%1'",
                $this->escapeHtml($this->_coreRegistry->registry('productdocument')->getTitle())
            );
        } else {
            return __('New Document');
        }
    }
