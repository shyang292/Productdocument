...
use Abm\Productdocument\Model\ProductdocumentFactory;

/**
 * Class Products
 * @package Abm\Productdocument\Model\ProductdocumentFactory
 */
class Products extends \Magento\Backend\Block\Widget\Grid\Extended
{
     ...
     * @param \Abm\Productdocument\Model\ProductdocumentFactory
    ...
    public function __construct(
        ...
        ProductdocumentFactory $contactFactory,
    ...
    public function _construct()
    {
        ...
        if ($this->getRequest()->getParam('productdocument_id')) {
    ...
    {
        $contactId = $this->getRequest()->getParam('productdocument_id');
