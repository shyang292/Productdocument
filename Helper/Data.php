...
namespace Abm\Productdocument\Helper;

use Magento\Framework\App\Filesystem\DirectoryList;

/**
 * Class Data
 * @package Abm\Productdocument\Helper
 */
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    /**
     * Path to store config where count of productdocument posts per page is stored
     *
     * @var string
     */
    const XML_PATH_ITEMS_PER_PAGE     = 'productdocument/view/items_per_page';
     ...
     * @var string
     */
    const MEDIA_PATH    = 'productdocument';
    ...
    /**
     * Return the base media directory for Productdocument Item images
     *
     * @return string
     */
    ...
    /**
     * Return the Base URL for Productdocument Item images
     *
     * @return string
     */
     ...
     * @return int
     */
    public function getProductdocumentPerPage()
    {
    ...
    {
        return $this->backendUrl->getUrl('productdocument/index/products', ['_current' => true]);
    }

    public function getCategoryGridUrl()
    {
        return $this->_backendUrl->getUrl('productdocument/index/products', ['_current' => true]);
    }
    /**
